...
if($_POST['submit'])
 { 
   ...
   $output=shell_exec("/usr/bin/mysqldump -u inventa_bd -pValenta@04  --lock-tables inventa_pglibreria tbl_cierre tbl_cliente tbl_facturas tbl_itemfactura tbl_sucursal tbl_autor tbl_editorial tbl_inventario tbl_distinventario tbl_usuario"); // ejemplo linux
    if(trim($output)==NULL)
     {
...
<body>
	<font size=4><b>Se respaldaran las siguientes tablas</b>:<br>
	tbl_autor<br>
	tbl_cierre<br>
	tbl_distinventario<br>
	tbl_cliente<br>
	tbl_editorial<br>
	tbl_facturas<br>
	tbl_inventario<br>
 ...
 <b>Haga click aqui para hacer un respaldo de las facturas</b></font>
