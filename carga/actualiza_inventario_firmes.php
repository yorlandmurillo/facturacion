...
//actualizacion de precio e iva en las tablas secundarias
	...
	<?		
		...
		fclose($ar); 
			...
			$sql_inventario="SELECT * FROM tbl_inventario2 where editorial='5555'";
			...
			if ($myrow2 = mysql_fetch_array($result_inventario)) 
			{
				...
				mysql_query("delete from tbl_inventario where editorial='5555'",$db);
				do 
				{
			...
			{
				mysql_query("delete from tbl_editorial where id_editorial='5555'",$db);
				do 
				{
			...
			$sql_autor="SELECT id_autor,aut_nombre,aut_pais FROM tbl_autor2 WHERE id_autor like 'A%'";
			...
			if ($myrow4 = mysql_fetch_array($result_autor)) 
			{
				...
				mysql_query("delete from tbl_autor WHERE id_autor like 'A%'",$db);
				do 
				{
