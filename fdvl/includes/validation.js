...
function buscaArticulo(fieldsFormatForm, edit){
	if(checkFormatFields(fieldsFormatForm)){
	    ...
	    popupArticulo = window.open("./buscaArticulo.php?editorial="+edit,"buscaArticulo","width=800,height=500,scrollbars=yes,left="+leftVal+",top="+topVal);
	    popupArticulo.focus();
	}
}
...
function buscaArticulo2(fieldsFormatForm, edit){
	if(checkFormatFields(fieldsFormatForm)){
	    ...
	    popupArticulo = window.open("./buscaArticulo2.php?editorial="+edit,"buscaArticulo2","width=700,height=500,scrollbars=yes,left="+leftVal+",top="+topVal);
	    popupArticulo.focus();
	}
}
...
function buscaArticulo3(fieldsFormatForm, edit){
	if(checkFormatFields(fieldsFormatForm)){
	    ...
	    popupArticulo = window.open("./buscaArticulo3.php?editorial="+edit,"buscaArticulo3","width=1100,height=350,scrollbars=yes,left="+leftVal+",top="+topVal);
	    popupArticulo.focus();
	}
}
	...
	if(checkFormatFields(fieldsFormatForm)){
		...
		if(table.rows.length > 1){
			for (i=1; i<table.rows.length; i++) {
				...
				precioUni[i-1]=table.rows[i].cells[6].childNodes[0].data;
	...
	if(checkFormatFields(fieldsFormatForm))
	{
		...
		if(table.rows.length > 1)
		{
			for (i=1; i<table.rows.length; i++) 
			{
				...
				editorial[i-1]=table.rows[i].cells[3].childNodes[0].data;
				cisbn[i-1]=table.rows[i].cells[4].childNodes[0].data;
				cbarra[i-1]=table.rows[i].cells[5].childNodes[0].data;
				tomo[i-1]=table.rows[i].cells[6].childNodes[0].data;
				presentacion[i-1]=table.rows[i].cells[7].childNodes[0].data;
				precioUni[i-1]=table.rows[i].cells[8].childNodes[0].data;
				cantidad[i-1]=table.rows[i].cells[9].childNodes[0].data;
				cantidad2[i-1]=table.rows[i].cells[10].childNodes[0].value;	
			}
			
			form.cod_libro.value = codArticulo.toString();
			form.cod_titulo.value = ctitulo.join("*");
			form.cod_autor.value = cautor.join("*");
			form.editorial.value = editorial.join("*");
			form.cod_isbn.value = cisbn.toString();
			form.cod_Barra.value = cbarra.toString();
			form.tomo.value = tomo.toString();
			form.presentacion.value = presentacion.toString();
			form.precio_libro.value = precioUni.join("+");
			form.cant_libro.value = cantidad.toString();
			form.cant_libro2.value = cantidad2.toString();
