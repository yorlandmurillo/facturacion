...
<form id="ftema" name="ftema" action="">
<br>
<table width="491" align="center" class="tabla" id="table1">
  <tr>
    <th colspan="5" bgcolor="#990000" style="-moz-border-radius:6px;"><span class="style1">Datos del Tema </span></th>
  </tr>
  
  <tr>
    <th width="143" ><div align="left">Tema: </div></th>
    <td colspan="4" class="campo" ><div align="left">
      <input type="text" name="tema" id="tema" size="90" maxlengtd="100" class="sinborde" />
    </div></td>
    </tr>
  ...
  <tr>
    <th colspan="7"> <input name="enviar" type="button" class="boton" id="enviar" onclick="agregartema()" value="Enviar" />
