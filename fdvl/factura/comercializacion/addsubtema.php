...
<form id="fsubtema" name="fsubtema" action="">
<br>
<table width="575" align="center" class="tabla" id="table1">
  <tr>
    <th colspan="5" bgcolor="#990000" style="-moz-border-radius:6px;"><span class="style1">Datos del Sub Tema </span></th>
  </tr>
  
  <tr>
    <th width="123" ><div align="left"> Sub Tema:</div></th>
    <td colspan="4" class="campo" ><div align="left">
      <input type="text" name="subtema" id="subtema" size="90" maxlengtd="100" class="sinborde" />
    </div></td>
    </tr>
  <tr>
  ...
  <tr>
    <td widtd="83">&nbsp;</td>
    <td colspan="2" widtd="90">&nbsp;</td>
    <td width="374" colspan="2" widtd="209">&nbsp;</td>
  </tr>
  <tr>
    <th colspan="7"> <input name="enviar" type="button" class="boton" id="enviar" onclick="agregarstema()" value="Enviar" />
