...
$buscar = "additemfactura.php";
$facturando = strpos($origen, $buscar);
if($facturando !== FALSE)
{
	$consultando=0;
}
...
<body <? if($facturando !== FALSE){?> onLoad="<? echo "printfactura('$factura',$vend,'$suc',$consultando)";?>"<?}?>>
...
?>
	<tr><td colspan="4" class="style4"><span class="style4">RIF: G-20007995-9 </span></td></tr>
	<tr><td colspan="4" class="style4"><span class="style2">Sucursal: <? echo $head["sucursal"]; ?></span></td></tr>
	<tr><td colspan="4" class="style4"><span class="style2">Teléfono: <? echo $head["telefono"]; ?></span></td></tr>
	<tr><td colspan="4" class="style4"><span class="style2">Vendedor: <? echo $head["vendedor"]; ?></span></td></tr>
	<tr><td colspan="4" class="style4"><span class="style2">Cliente: <? echo $nombre; ?></span></td></tr>
	<tr><td colspan="4" class="style4"><span class="style2">C.I/RIF: <? echo $head["cedula"]; ?></span></td></tr>
	<tr><td colspan="4" class="style4"><span class="style2">Factura: <? echo $head["factura"]; ?></span></td></tr>
	<?
	if($head["codfacturamanual"]!='' && $head["codfacturamanual"]>0)
	{
	?>
	<tr><td colspan="4" class="style4"><span class="style2">Codigo Talonario: <? echo "<b>".$head["codfacturamanual"]."</b>"; ?></span></td></tr>
	<tr><td colspan="4" class="style4"><span class="style2">Numero Talonario: <? echo "<b>".$head["numtalonario"]."</b>"; ?></span></td></tr>
	<?
	}
	?>
	<tr><td colspan="4"><div align="center"><span class="style2">&quot;Contribuyente Formal&quot;</span></div></td></tr>
	<tr><td colspan="4"><span class="style4">Fecha: <? echo  $head["fecha"]; ?></span></td></tr>
     ...
     {         
		...
		<?
		 ...
		 $pts="...";
  		...
  		?>
		<td><div align='left'><? echo $row["producto"]; ?></div></td>
         <td><div align='left'><? echo substr($row["descripcion"],0,6).$pts; ?></div></td>
        <td><div align='center' ><? echo $row["cant"]; ?></div></td>
         <td align='center'><div align='right'><? echo number_format($row["precio"],2,',','.'); ?></div></td>
		<td align='center'><div align='center'><? echo $row["descuento"]*100; ?></div></td>
		</tr>
		<?
        $i++;    
     }   
...
?>
  <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
  <tr><td class="style6" colspan="5" align="right" ><strong>Total Cancelar:&nbsp;&nbsp;<? echo number_format($head["monto"],2,',','.'); ?></strong></td></tr>
  <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
  <tr><td class="style4" colspan="3">FORMA DE PAGO</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
<?
if($head["efec"]>0)
{
?>
	<tr><td>Efectivo:</td><td align="right"><? echo number_format($head["efec"],2,',','.'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<?
}
...
{
?>
	<tr><td>Cheque:</td><td align="right"><? echo number_format($head["cheque"],2,',','.'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<?
}
if($head["tdb"]>0)
{
?>
	<tr><td>TDB:</td><td align="right"><? echo number_format($head["tdb"],2,',','.'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<?
}
...
{
?>
	<tr><td>TDC:</td><td align="right"><? echo number_format($head["tdc"],2,',','.'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<?
}
...
{
?>
	<tr><td>Bonolibro:</td><td align="right"><? echo number_format($head["bl"],2,',','.'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
 <?
}
if($head["cesta"]>0)
{
?>
	<tr><td>C. Ticket:</td><td align="right"><? echo number_format($head["cesta"],2,',','.'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<?
}
...
{
?>
	<tr><td>Especial:</td><td align="right"><? echo number_format($head["esp"],2,',','.'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<?
}
...
{
?>
	<tr><td>O.Moneda:</td><td align="right"><? echo number_format($head["omoneda"],2,',','.'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<?
}
?>
<tr><td>Cambio:</td><td align="right"><? echo number_format($head["cambio"],2,',','.'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>Monto iva:</td><td align="right"><? echo number_format($head["mto_iva"],2,',','.'); ?></td><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td colspan="5" align="center">&nbsp;</td></tr>
<tr><td colspan="5" align="center">Libros Vendidos: <? echo $totallibros; ?></td></tr>
<tr><td colspan="5" align="center">&nbsp;</td></tr>
<tr><td colspan="5" align="center">Depues de (3) d&iacute;as no se aceptan devoluciones</td></tr>
</table>
...
<form id="print" name="print" method="post" action="">
  ...
  <? if($facturando !== FALSE){echo "disabled";}else{?>onclick="<? echo "printfactura('$factura',$vend,'$suc',$consultando)";?>" class="boton noimprime"<?}?> />
...
if (!($link2= @mysql_connect("db.libreriasdelsur.gob.ve","libsur","L#ibsur*")))
{
