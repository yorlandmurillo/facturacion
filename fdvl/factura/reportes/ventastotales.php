...
$pdf->AliasNbPages();
$sql="SELECT tbl_facturas.cod_factura, tbl_facturas.fecha_factura, tbl_facturas.sucursal, tbl_facturas.vendedor, tbl_facturas.mto_total, tbl_facturas.estatus_factura FROM tbl_facturas where tbl_facturas.sucursal=$sucursal and tbl_facturas.estatus_factura=3 ORDER BY tbl_facturas.fecha_factura DESC,tbl_facturas.vendedor asc;"; 
