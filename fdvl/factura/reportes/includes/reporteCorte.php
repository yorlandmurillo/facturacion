  ...
  <table width="729">
    ...
    <tr>
      ...
      <td colspan="3">
        ...
        <img src="images/img.gif" alt="" name="f_trigger_c" id="f_trigger_c"
    ...
    <tr>
      ...
      <td colspan="3">
        <input size="10" type="text" id="fch_creacion2" name="fch_creacion2" value="<? echo cambiaf_a_normal($fch_creacion2);?>" readonly="readonly" />
        
        <img src="images/img.gif" alt="" name="f_trigger_c2" id="f_trigger_c2"
										style="cursor: pointer; border: 1px solid #990000;"
										title="Date selector"
										onmouseover="this.style.background='990000';"
										onmouseout="this.style.background=''" />
