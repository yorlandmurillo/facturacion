...
<table border="1" width="100%" id="table1" style="border-width: 0px" height="198">
	...
	<tr>
		...
		<td height="15" align="left" valign="top" bgcolor="#FFFFFF" style="border-style: none; border-width: medium"><p class="CIREDLink">Este Proceso puede tardar varios minutos, el mismo actualiza  de manera autom&aacute;tica la informaci&oacute;n m&aacute;s reciente de Libros.</p>
	      <p class="CIREDLink">&nbsp;</p>
	  <p class="CIREDLink">          <li class="CIREDLista"><a class="CIREDLista" href="inventario.php?p=actualizar2" ><span class="CIREDContenidoTabla" ><span class="CIREDLink">Presione aquí para Inicializar Actualización</span></span></a></p></td><td height="15" align="right" valign="top" bgcolor="#FFFFFF" style="border-style: none; border-width: medium"><img src="images/body1.jpg" width="183" height="164" align="top" /></td>
	</tr>
