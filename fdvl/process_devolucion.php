...
$msg="La Devolución ha sido guardado con exito";

}else{
			 	$msg="Error al intertar guardar la Devolución";
			 }
		 }else{
		 	$msg="Error al intertar guardar la Devolución";
		 }
...
<form name="frmPedido" method="post" action="excel_pedido.php">
	...
	<tr><td><p>&nbsp;</p></td></tr>
	<tr align="center"><td><p>Código de Devolución:  <?php echo $cod_pedido; ?></p></td></tr>
	<tr><td><p>&nbsp;</p></td></tr>
	<tr align="center">
		<td> 
