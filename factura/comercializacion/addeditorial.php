...
<form id="feditorial" name="feditorial" action="">
<br>
<table width="491" align="center" class="tabla" id="table1">
  <tr>
    <th colspan="5" bgcolor="#990000" style="-moz-border-radius:6px;"><span class="style1">Datos de la Editorial </span></th>
  </tr>
  <tr>
    <th width="143" ><div align="left">Editorial: </div></th>
    <td colspan="4" class="campo" ><div align="left">
      <input type="text" name="editorial" id="editorial" size="90" maxlengtd="100" class="sinborde" />
    </div></td>
    </tr>
  ...
  <tr>
    <th colspan="7"> <input name="enviar" type="button" class="boton" id="enviar" onclick="agregareditorial()" value="Enviar" />
